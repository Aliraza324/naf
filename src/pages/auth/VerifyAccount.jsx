        ...
        <div className='relative z-10 flex min-h-[calc(100vh-2rem)] items-center justify-center px-4 py-12'>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className='mt-8'>
              ...
              <button
                type='submit'
                className='mt-12 h-11 w-full rounded-[6px] bg-primary text-xs font-black text-white shadow-[0_10px_24px_rgba(230,1,3,0.22)] transition hover:bg-primary-hover active:translate-y-0.5'
              >
                Verify
              </button>
            </form>
