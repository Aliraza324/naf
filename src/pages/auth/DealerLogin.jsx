...
const DealerLogin = () => {
  ...
  useEffect(() => {
    // Clear any lingering error from previous sessions on mount
    dispatch(clearError())
  }, [dispatch])
  ...
  const handleInputChange = (event) => {
    ...
    // Clear global auth error if user starts typing again
    if (error) {
      dispatch(clearError())
    }
  }
                ...
                <div>
                  ...
                  <div className='relative'>
                    ...
                    <input
                      ...
                      className={`h-11 w-full rounded-[6px] border bg-[#111113] pl-10 pr-4 text-xs font-semibold text-white outline-none transition placeholder:text-white/22 ${
